    ...
    $(document).ready(function() {
        $.getJSON("./../resources/employees.json", function(data) {
            ...
            $.each(data, function(key, value) {
                ...
                employee_data += "<div class='col-1 flex-row'><form method='DELETE' action='./library/employeeController.php' onsubmit='return confirmDelete()'><input type='hidden' name='id' value='" + value.id + "'><button type='submit'><i class='bi bi-trash'></i></button></form></div>";
                employee_data += "</div>";
            });
