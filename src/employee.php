...
<form class="row g-3 needs-validation" novalidate>
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustom01" <?php if (isset($name)){echo "value='$name'";} ?> placeholder="name" required>
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustom02" <?php if (isset($lastName)){echo "value='$lastName'";} ?> placeholder="last name" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustomEmail" <?php if (isset($email)){echo "value='$email'";}?> placeholder = "email direction" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustom03" <?php if (isset($city)){echo "value='$city'";}?> placeholder = "city" required>
    <div class="invalid-feedback">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustomSaddress" <?php if(isset($streetA)){echo "value='$streetA'";}?> placeholder = "street address"required>
    <div class="invalid-feedback">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustomSaddress" <?php if(isset($state)){echo "value='$state'";}?> placeholder = "State"required>
    <div class="invalid-feedback">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustomAge" <?php if(isset($age)){echo "value='$age'";}?> placeholder = "Age" required>
    <div class="invalid-feedback">
      Type an age.
    </div>
  </div>
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustom05" <?php if(isset($postalCode)){echo "value='$postalCode'";}?>" placeholder = "Postal Code" required>
    <div class="invalid-feedback">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustom06" <?php if(isset($phoneNum)){echo "value='$phoneNum'";}?> placeholder = "Phone number" required>
    <div class="invalid-feedback">
