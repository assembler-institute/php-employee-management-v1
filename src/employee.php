    ...
    <section class="section-employee">
        <form action="./library/employeeController.php?userID=<?= $_GET['userId']?>" method="POST" class="employee" id="employee">
            <div class="employee__grupo" id="grupo__name">
                ...
                <input type="text" class="employee__input" name="name" id="name" value="<?=getEmployee($_GET['userId'])['name']?>">
            </div>
            <div class="employee__grupo" id="grupo__lastName">
                <label for="lastName" class="employee__label">Last name</label>
                <input type="text" class="employee__input" name="lastName" id="lastName" value="<?=getEmployee($_GET['userId'])['lastName']?>">
            </div>
            <div class="employee__grupo" id="grupo__email">
                <label for="email" class="employee__label">Email address</label>
                <input type="email" class="employee__input" name="email" id="email" value="<?=getEmployee($_GET['userId'])['email']?>">
            </div>
            <div class="employee__grupo" id="grupo__gender">
                ...
                <select name="gender" class="employee__input">
                    <option value="man" <?=(getEmployee($_GET['userId'])["gender"] == "man") ? "selected" : ""?>>man</option>
                    <option value="woman" <?=(getEmployee($_GET['userId'])["gender"] == "woman") ? "selected" : ""?>>woman</option>
                </select>
            </div>
            <div class="employee__grupo" id="grupo__city">
                <label for="city" class="employee__label">City</label>
                <input type="text" class="employee__input" name="city" id="city" value="<?=getEmployee($_GET['userId'])['city']?>">
            </div>
            <div class="employee__grupo" id="grupo__streetAddress">
                <label for="streetAddress" class="employee__label">Street address</label>
                <input type="text" class="employee__input" name="streetAddress" id="streetAddress" value="<?=getEmployee($_GET['userId'])['streetAddress']?>">
            </div>
            <div class="employee__grupo" id="grupo__state">
                <label for="state" class="employee__label">State</label>
                <input type="text" class="employee__input" name="state" id="state" value="<?=getEmployee($_GET['userId'])['state']?>">
            </div>
            <div class="employee__grupo" id="grupo__age">
                <label for="age" class="employee__label">Age</label>
                <input type="text" class="employee__input" name="age" id="age" value="<?=getEmployee($_GET['userId'])['age']?>">
            </div>
            <div class="employee__grupo" id="grupo__postalCode">
                <label for="postalCode" class="employee__label">Postal code</label>
                <input type="text" class="employee__input" name="postalCode" id="postalCode" value="<?=getEmployee($_GET['userId'])['postalCode']?>">
            </div>
            <div class="employee__grupo" id="grupo__phoneNumber">
                <label for="phoneNumber" class="employee__label">Phone number</label>
                <input type="text" class="employee__input" name="phoneNumber" id="phoneNumber" value="<?=getEmployee($_GET['userId'])['phoneNumber']?>">
            </div>
