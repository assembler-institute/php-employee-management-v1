            ...
            <div class="card">
                <form class="form-card" onsubmit="event.preventDefault()">
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> <label>First name</label> <input type="text" id="fname" name="fname" value="<?=returnData("name");?>"> </div>
                        <div class="form-group col-sm-6 flex-column d-flex"> <label>Last name</label> <input type="text" id="lname" name="lname" value="<?=returnData("lastName");;?>"> </div>
                    </div>
                    <div class="row justify-content-between text-left">
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex"> <label>Street Address</label> <input type="text" id="street" name="street" value="<?=returnData("streetAddress");?>"> </div>
                    </div>
                    <div class="row justify-content-between text-left">
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> <label>Postal Code</label> <input type="number" id="postal" name="postal" value="<?=returnData("postalCode");?>"> </div>
                        <div class="form-group col-sm-6 flex-column d-flex"> <label>Phone Number</label> <input type="tel" id="phone" name="phone" value="<?=returnData("phoneNumber");?>"> </div>
                    </div>
